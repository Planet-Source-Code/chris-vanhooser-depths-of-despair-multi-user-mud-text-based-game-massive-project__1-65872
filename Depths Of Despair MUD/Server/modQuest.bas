...
'20  See Invisible   0 or 1
'21  See Hidden  0 or 1
'22  Can Eq Ring0    0 or 1
'23  Can Eq Ring1    0 or 1
'24  Can Eq Ring2    0 or 1
'25  Can Eq Ring3    0 or 1
'26  Can Eq Ring4    0 or 1
'27  Can Eq Ring5    0 or 1
'28  Can DualWield   0 or 1
'29  Can Steal   0 or 1
'30  Can Backstab    0 or 1
        ...
        Select Case i
            Case 6
                If .sHead <> "0" And l = 1 Then
                    ...
                    WrapAndSend dbPlayers(dbIndex).iIndex, LIGHTBLUE & "Your " & modGetData.GetItemNameWithS(GetItemID(, s)) & "to the ground." & WHITE & vbCrLf, False
                End If
            Case 7
...
With dbPlayers(dbIndex)
    ...
    Arr(2) = CStr(modGetData.GetPlayersBaseMR(dbIndex))
    Arr(4) = CStr(modGetData.GetPlayersPerceptionBase(dbIndex, False))
